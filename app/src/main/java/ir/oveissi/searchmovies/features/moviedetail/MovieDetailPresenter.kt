...
constructor(private val mMovieInteractor: MovieInteractor) : MovieDetailContract.Presenter {
    private lateinit var viewLayer: MovieDetailContract.View
    private val compositeDisposable = mutableListOf<Job>()

    override fun onLoadMovieDetail(id: String) {

        val job = launch(UI) {
            try {
                val movie = mMovieInteractor.getMovieByID(id)
    ...
    override fun onViewAttached(view: MovieDetailContract.View) {
        viewLayer = view
    }
